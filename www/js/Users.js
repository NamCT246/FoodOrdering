  ...
  return {
    login: function(username, password) {
      return $q(function(resolve, reject){
        $http.post(API_ENDPOINT.url + "clientLogin", { username: username, password: password}).then(function(result){
    ...
    signup: function( newusername, newpassword) {
      return $q(function(resolve, reject){
        $http.post(API_ENDPOINT.url + "clientSignup", { username: newusername, password: newpassword}).then(function(result){
          if(result.status == 200)
          {
            resolve();
          }
